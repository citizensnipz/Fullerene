...
def build_decision_trace(
    *,
    ...
    return {
        ...
        "unresolved_reference_count": signals.text.unresolved_reference_count,
        "reference_resolution_confidence": signals.text.reference_resolution_confidence,
        "has_resolved_reference": signals.text.has_resolved_reference,
        "has_unresolved_reference": signals.text.has_unresolved_reference,
        "current_topic_hint": signals.continuity_topic_hint,
        "reference_continuity_reasons": list(signals.text.reference_continuity_reasons),
